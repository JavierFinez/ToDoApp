package io.keepcoding.todo.ui.taskdetail
...
class TaskDetailActivity : BaseActivity(), EditTaskFragment.OnDismissListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val bundle = Bundle()
        bundle.putLong("parentTaskId", task!!.id)
    ...
    private fun bindEvents() {
        with (taskViewModel) {
            taskDeletedEvent.observe(this@TaskDetailActivity, Observer {
                setResult(Activity.RESULT_OK)
                finish()
            })

            taskEvent.observe(this@TaskDetailActivity, Observer {
